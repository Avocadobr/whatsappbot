...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=5521996372211:+55 2199637-2211\n' // WhatsApp ID + phone number
            + 'END:VCARD'
/******END OF VCARD INPUT******/
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Oii @${num.split('@')[0]}\ Seja bem vindo (a) ao grupo, leia as regras na descrição💖🙃, *${mdata.subject}*`
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '⏄1�7 Aguarde... 🥑',
				success: '✄1�7 Sucesso 🥑',
                                levelon: '❄1�71ￄ1�77 ✄1�71ￄ1�77 ❄1�71ￄ1�77 *permitir o nivelamento*', 
				leveloff: ' ❄1�71ￄ1�77 X ❄1�71ￄ1�77  *desabilitar nivelamento*',
				levelnoton: '❄1�71ￄ1�77 X ❄1�71ￄ1�77 *a nota de nivelamento não está ativa*',
				levelnol: '*NÍVEL DE IRMÃO AINDA * 0 °-°',
				error: {
					stick: '[❗] Falha, ocorreu um erro ao converter a imagem em um adesivo ❄1�71ￄ1�77',
					Iv: '❄1�71ￄ1�77 Link invalido ❄1�71ￄ1�77'
				},
				only: {
					group: '[❗] Comando pode ser usado apenas nos grupos! ❄1�71ￄ1�77',
					ownerG: '[❗] Este comando só pode ser usado pelo grupo proprietário! ❄1�71ￄ1�77',
					ownerB: '[❗] Este comando só pode ser usado pelo proprietário do bot! ❄1�71ￄ1�77',
					admin: '[❗]KKK MEMBRO COMUM TENTANDO USAR COMANDO DE ADEMIR🤡',
					Badmin: '[❗] O BOT PRECISA SER ADEMIR DO GRUPO ❄1�71ￄ1�77',
                                    
				}
			}
    			const apakah = ['Sim não']
        		const bisakah = ['Sim, você não pode']
		        const kapankah =  ['Dias de atraso ',' Mais domingo ',' Mais meses ',' Mais anos']
			const botNumber = client.user.jid
			const ownerNumber = ["5521996372211@s.whatsapp.net"] // replace this with your number
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '5521996372211@s.whatsapp.net'
                        /******ApiKey Input******/
            ...
            try {
                ...
                if (requiredXp <= getLevelingXp(sender)) {
                    ...
                    await reply(`*〄1�71ￄ1�77  SUBIU DE NÍVEL 〄1�71ￄ1�77*\n\n➄1�71ￄ1�77 *Nome*: ${sender}\n➄1�71ￄ1�77 *XP*: ${getLevelingXp(sender)}\n➄1�71ￄ1�77 *NIVEL*: ${getLevel} -> ${getLevelingLevel(sender)}\n\N PARABÉNS! 🎉🎉`)
                }
            } catch (err) {
                console.error(err)
            }
...
case 'timer':
		...
		client.sendMessage(from, bahasa(prefix, sender), text, {quoted: mek})
               ...
               break
				case 'demote':
					...
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('Tags-alvo que os administradores querem baixar')
					...
					if (mentioned.length > 1) {
						...
						mentions(`KKK ISSO QUE DÁ QUANDO MAMA OS ADM ERRADO AGORA É MEMBRO COMUM @${mentioned[0].split('@')[0]}\n 🐒 _*${groupMetadata.subject}*_`, mentioned, true)
						client.groupDemoteAdmin(from, mentioned)
					}
					break
                                case 'randomhentai':
                  ...
                  case 'promote':
					...
					if (mentioned.length > 1) {
						...
						mentions(`Sem escândalo fml esse mamou os adm pra deixar de ser membro comum: @${mentioned[0].split('@')[0]}`, mentioned, true)
						client.groupMakeAdmin(from, mentioned)
					}
					break
				  case 'wa.me':
  ...
  client.updatePresence(from, Presence.composing) 
      options = {
          text: `〄1�71ￄ1�77 *AUTO WHATSAPP* 」\n\n_Solicitado por_ : *@${sender.split("@s.whatsapp.net")[0]}\n\nSeu do link WhatsApp : *https://wa.me/${sender.split("@s.whatsapp.net")[0]}*\n*Or ( / )*\n*https://api.whatsapp.com/send?phone=${sender.split("@")[0]}*`,
    ...
    client.sendMessage(from, options, text, { quoted: mek } )
			...
			case 'quotes':
				...
				ez = `*➄1�71ￄ1�77 Autor :* ${data.author}\n*➄1�71ￄ1�77 citações:* ${data.quotes}`
				reply(ez)
				break
				case '3dtext':
              ...
              case 'owner':
                case 'criador':
                  client.sendMessage(from, {displayname: "Abacatin", vcaurd: vcaurd}, MessageType.contact, { quoted: mek})
              ...
              await client.sendMessage(from, options, text)
               break
					...
					try {
						...
						reply('Nome de usuario invalido')
					}
					break
				case 'snowwrite':
		...
		case 'spamcall':
               client.updatePresence(from, Presence.composing)
				...
				case 'ytmp3':
					...
					teks = `❄1�71ￄ1�77 *Titulo* : ${anu.title}\n❄1�71ￄ1�77 *Tamanho* : ${anu.filesize}\n\nEspere Um Pouco Mano, Audio Esta Sendo Enviado Novamente...`
	...
	case 'kbbi':
	      ...
	      tels = body.slice(6)
			...
			tels = body.slice(6)
               ...
               if (data.error) return reply(data.error)
				...
				case 'tts':
				   ...
				   if (args.length < 1) return client.sendMessage(from, 'Cade o codigo da linguagem mano?', text, {quoted: mek})
                                   if (!isUser) return reply(mess.only.daftarB)
					...
					rano = getRandom('.ogg')
					dtt.length > 600
					? reply('A maior parte do texto ￄ1�71ￄ1�77 tio')
				...
				client.updatePresence(from, Presence.composing) 
					...
					mentions('╔══✪〄1�71ￄ1�77 Mencione Tudo 〙✪══\n╠➥'+teks+'╚═〄1�71ￄ1�77 - - - - 〄1�71ￄ1�77', members_id, true)
					break
                case 'tagall2':
				client.updatePresence(from, Presence.composing) 
					if (!isGroup) return reply(mess.only.group)
					...
					client.sendMessage(from, '╔══✪〄1�71ￄ1�77 Mencione Tudo 〙✪══\n╠➥'+teks+'╚═〄1�71ￄ1�77 - - - - 〄1�71ￄ1�77', text, {quoted: mek})
					break
                case 'tagall3':
				client.updatePresence(from, Presence.composing) 
					if (!isGroup) return reply(mess.only.group)
					...
					client.sendMessage(from, '╔══✪〄1�71ￄ1�77 Mencione Tudo 〙✪══\n╠➥'+teks+'╚═〄1�71ￄ1�77 - - - - - 〄1�71ￄ1�77', text, {detectLinks: false, quoted: mek})
					break
                        case 'tagall4':
				client.updatePresence(from, Presence.composing) 
					if (!isGroup) return reply(mess.only.group)
				...
				client.updatePresence(from, Presence.composing) 
					...
					reply('╔══✪〄1�71ￄ1�77 Mencione Tudo 〙✪══\n╠➥'+teks+'╚═〄1�71ￄ1�77 - - - - - 〄1�71ￄ1�77')
					break
				case 'send':
					var pc = body.slice(6)
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `*〄1�71ￄ1�77 BROADCAST 〄1�71ￄ1�77*\n\n${body.slice(4)}`})
						}
						reply('')
					} else {
						for (let _ of anu) {
							sendMess(_.jid, `*〄1�71ￄ1�77 TRANSMISSÃO 〄1�71ￄ1�77*\n\n${body.slice(4)}`)
						}
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of groupMembers) {
							client.sendMessage(_.jid, buff, image, {caption: `*〄1�71ￄ1�77 BC GROUP 〄1�71ￄ1�77*\n*Group* : ${groupName}\n\n${body.slice(6)}`})
						}
						reply('')
					} else {
						for (let _ of groupMembers) {
							sendMess(_.jid, `*〄1�71ￄ1�77 BC GROUP 〄1�71ￄ1�77*\n*Group* : ${groupName}\n\n${body.slice(6)}`)
						}
				...
				case 'chord':
					if (args.length < 1) return reply('o título da canção onde kak')
                                        if (!isUser) return reply(mess.only.daftarB)
					tels = body.slice(7)					
			...
			case 'igstalk':
               ...
               client.updatePresence(from, Presence.composing) 
              options = {
          text: `O dono do grupo é:  @${from.split("-")[0]}`,
          contextInfo: { mentionedJid: [from] }
           ...
           break
				...
				case 'add':
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (args.length < 1) return reply('Quem vc deseja adicionar🧐??')
					if (args[0].startsWith('08')) return reply('Use o codigo do país anta🙄')
					try {
						num = `${args[0].replace(/ /g, '')}@s.whatsapp.net`
						client.groupAdd(from, [num])
					} catch (e) {
						console.log('Error :', e)
						reply('Falha ao adicionar, talvez seja privado. mande o link no pv')
					}
					break
				...
				case 'kick':
					...
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = 'Removi esse satanas com sucesso🐒 :\n'
						for (let _ of mentioned) {
							teks += `@${_.split('@')[0]}\n`
						}
						mentions(teks, mentioned, true)
				...
				case 'ocr':
					...
					break
                     ...
                     const bug = body.slice(5)
                      if (pesan.length > 300) return client.sendMessage(from, 'Desculpe, texto muito longo, maximo de 300 caracteres', msgType.text, {quoted: mek})
                    ...
                    reply('O problema foi relatado ao proprietario do BOT, relatorio falso/main2 nao sera respondido.')
                    break
               case 'apakah':
               client.updatePresence(from, Presence.composing) 
	    ...
	    case 'kapankah':
			...
			case 'closegc':
                ...
                case 'bukagc':
					...
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					open = {
					text: `Grupo aberto pelo ademar @${sender.split("@")[0]}\nagora *os membros comum* podem falar `,
					contextInfo: { mentionedJid: [sender] }
					}
					...
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						await ffmpeg(`./${media}`)
							...
							.on('error', function (err) {
								...
								reply(`❄1�71ￄ1�77 Falhou, no momento da conversao ${tipe} ke stiker`)
							})
							.on('end', function () {
								console.log('Finish')
				...
				case 'toimg':
				    client.updatePresence(from, Presence.composing)
                                    if (!isUser) return reply(mess.only.daftarB)
					if (!isQuotedSticker) return reply('❄1�71ￄ1�77 adesivo de resposta um ❄1�71ￄ1�77')
					reply(mess.wait)
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						fs.unlinkSync(media)
						if (err) return reply('❄1�71ￄ1�77 Falha ao converter adesivos em imagens ❄1�71ￄ1�77')
                	...
                	client.updatePresence(from, Presence.composing) 
                        if (!isUser) return reply(mess.only.daftarB)
					if (!isQuotedVideo) return reply('❄1�71ￄ1�77 responda o video um ❄1�71ￄ1�77')
					reply(mess.wait)
					encmedia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
					media = await client.downloadAndSaveMediaMessage(encmedia)
					ran = getRandom('.mp4')
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						fs.unlinkSync(media)
						if (err) return reply('❄1�71ￄ1�77 Falha ao converter video para mp3 ❄1�71ￄ1�77')
						buffer = fs.readFileSync(ran)
               ...
               if (anu.error) return reply(anu.error)
                ...
                break
                   ...
                   break
					...
					anu = await fetchJson(`http://rt-files.000webhostapp.com/tts.php?apikey=rasitech`, {method: 'get'})
                                        if (!isUser) return reply(mess.only.daftarB)
					setTimeout( () => {
					client.sendMessage(from, '*➄1�71ￄ1�77 Jawaban :* '+anu.result.jawaban+'\n'+anu.result.desk, text, {quoted: mek}) // ur cods
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
					client.sendMessage(from, '_10 Detik lagi…_', text) // ur cods
					}, 20000) // 1000 = 1s,
					setTimeout( () => {
					client.sendMessage(from, '_20 Detik lagi_ 1�71ￄ1�77', text) // ur cods
					}, 10000) // 1000 = 1s,
					setTimeout( () => {
					client.sendMessage(from, '_30 Detik lagi_ 1�71ￄ1�77', text) // ur cods
					}, 1000) // 1000 = 1s,
					setTimeout( () => {
					...
					if (Number(args[0]) === 1) {
						...
						reply('❄1�71ￄ1�77 SUCESSO ❄1�71ￄ1�77 ative o recurso de boas-vindas neste grupo')
					} else if (Number(args[0]) === 0) {
						welkom.splice(from, disable)
						fs.writeFileSync('./database/json/welkom.json', JSON.stringify(welkom))
						reply('❄1�71ￄ1�77 SUCESSO ❄1�71ￄ1�77 desative o recurso de boas-vindas neste grupo')
					} else {
					...
					if (args.length < 1) return reply(mess.blank)
                                        if (!isUser) return reply(mess.only.daftarB)
					tels = body.slice(7)
					if (tels.length > 15) return reply('Texto muito longo, ate 20 caracteres')
					reply(mess.wait)
				...
				if (isUser) return reply(mess.only.daftarB)
					...
					break
                                case 'nsfwneko':
				    try{
						if (!isNsfw) return reply('❄1�71ￄ1�77 *NSFW ESTÁ DESLIGADO* ❄1�71ￄ1�77')
                                                if (!isUser) return reply(mess.only.daftarB)
						...
						console.log(`Error :`, color(e,'red'))
						reply('❄1�71ￄ1�77 *ERRO* ❄1�71ￄ1�77')
					}
					break
                                case 'shota':
				    try{
				...
				case 'logowolf':
					...
					if (Number(args[0]) === 1) {
						...
						reply('❄1�71ￄ1�77 SUCESSO ❄1�71ￄ1�77 ative o recurso nsfw neste grupo')
					} else if (Number(args[0]) === 0) {
						nsfw.splice(from, 1)
						fs.writeFileSync('./database/json/nsfw.json', JSON.stringify(nsfw))
						reply('❄1�71ￄ1�77 SUCESSO ❄1�71ￄ1�77 desabilite o recurso nsfw neste grupo')
					} else {
						reply('digite 1 para ativar, 0 para desativar o recurso')
					}
					break	
                ...
                resul = `◄1�71ￄ1�77 *LEVEL*\n  ├─ ❄1�71ￄ1�77 *Nome* : ${sem}\n  ├─ ❄1�71ￄ1�77 *Usuario XP* : ${userXp}\n  └─ ❄1�71ￄ1�77 *Level do usuario* : ${userLevel}`
            ...
            break
                                ...
                                case 'nsfwtrap':
                                        try{
                                                if (!isNsfw) return reply('❄1�71ￄ1�77 *NSFW DESATIVADO* ❄1�71ￄ1�77')
                                                if (!isUser) return reply(mess.only.daftarB)
                                                ...
                                                console.log(`*Error* :`, color(e,'red'))
                                                reply('❄1�71ￄ1�77 *ERROR* ❄1�71ￄ1�77')
                                        }
                                        break
                                case 'ping':
			       ...
			       reply(anu.result.jadwalTV)
					break
                                ...
                                case 'shadow':
                                        ...
                                        buffer = await getBuffer(anu.result)
                                        client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Aqui está a foto viadenho😂🇧🇼'})
                                        break
                                case 'burnpaper':
                                        var gh = body.slice(10)
                                        var teks1 = gh.split("|")[0];
                                ...
                                case 'qowheart':
                                        var gh = body.slice(9)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply('onde estￄ1�71ￄ1�77 o texto hum\nExemplos: ${prefix}qowheart lorde')
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
				...
				case 'simi':
					...
					//if (anu.error) return reply('Simi Nao sei mano')
					reply(anu)
					break
				case 'simih':
					if (!isGroup) return reply(mess.only.group)
				...
				case 'clone':
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (args.length < 1) return reply('Marque o alvo que vocￄ1�71ￄ1�77 deseja clonar')
					...
					break
                                ...
                                case 'pubglogo':
                                        ...
                                        var teks1 = gh.split("|")[0];
                                        var teks2 = gh.split("|")[1];
                                        if (args.length < 1) return reply('onde está o texto? \ nExemplos: ${prefix}pubglogo Nazwa|Canss')
                                        if (!isUser) return reply(mess.only.daftarB)
                                        ...
                                        buffer = await getBuffer(anu.result)
                                        client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Aqui está o logotipo...'})
                                        break
                                case 'herrypotter':
                                case 'harrypotter':
                                        var gh = body.slice(12)
				...
				default:
					if (isGroup && isSimi && budy != undefined) {
					    ...
					    return reply("[🥑] Bem vindo, Eu sou o Abacate Bot e estou aqui para criar figurinhas, Mande sua imagem com a legenda *.sticker* ou um video curto com a legenda *.stickergif* para figurinha animada [🥑]");
